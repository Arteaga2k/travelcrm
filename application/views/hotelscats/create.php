...
<div class="column span-20 last">
	<?=form_input('code', set_value('code', ''), 'id="code" class="text part"')?>
</div>
<div class="column span-4">
	<?=form_label(lang('NAME').required_field(), 'hotelcat_name')?>
</div>
<div class="column span-20 last">
	<?=form_input('hotelcat_name', set_value('hotelcat_name', ''), 'id="hotelcat_name" class="text part-5"')?>
</div>
