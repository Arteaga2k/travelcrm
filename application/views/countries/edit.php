...
<?}?>
<div class="column span-4">	<?=form_label(lang('CODE').required_field(), 'country_code')?></div><div class="column span-20 last">	<?=form_input('country_code', set_value('country_code', $ds->country_code), 'id="country_code" class="text part"')?></div><div class="column span-4">	<?=form_label(lang('NAME').required_field(), 'country_name')?></div><div class="column span-20 last">	<?=form_input('country_name', set_value('country_name', $ds->country_name), 'id="country_name" class="text part-5"')?></div><div class="column span-4">	<?=form_label(lang('NAME_LAT').required_field(), 'country_name_lat')?></div><div class="column span-20 last">	<?=form_input('country_name_lat', set_value('country_name_lat', $ds->country_name_lat), 'id="country_name_lat" class="text part-5"')?></div>
<div class="column span-4">
