...
<div class="column span-20 last">
	<?=form_dropdown('_countries_rid', get_countries_list(), set_value('_countries_rid', ''), 'id="_countries_rid" class="text part-5" ')?>
</div>
...
<div class="column span-20 last">
	<?=form_input('city_name', set_value('city_name', ''), 'id="city_name" class="text part-5" ')?>
</div>
<div class="column span-4">
	<?=form_label(lang('NAME_LAT').required_field(), 'city_name_lat')?>
</div>
<div class="column span-20 last">
	<?=form_input('city_name_lat', set_value('city_name_lat', ''), 'id="city_name_lat" class="text part-5" ')?>
</div>
