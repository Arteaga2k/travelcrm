...
<div class="column span-4">
	<?=form_label(lang('NAME'), 'interests_name')?>
</div>
<div class="column span-20 last">
	<?=form_input('interests_name', set_value('interests_name', $ds->interests_name), 'id="interests_name" class="text part-5" readonly="readonly"')?>
</div>
