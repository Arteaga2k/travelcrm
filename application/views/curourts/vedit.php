...
<div class="column span-4">	<?=form_label(lang('COUNTRY').required_field(), '_countries_rid')?></div><div class="column span-20 last">	<?=form_dropdown('_countries_rid', get_countries_list(), set_value('_countries_rid', $ds->_countries_rid), 'id="_countries_rid" class="text" ')?></div><div class="column span-4">	<?=form_label(lang('NAME').required_field(), 'curourt_name')?></div><div class="column span-20 last">	<?=form_input('curourt_name', set_value('curourt_name', $ds->curourt_name), 'id="curourt_name" class="text part-5" ')?></div><div class="column span-4">	<?=form_label(lang('NAME_LAT').required_field(), 'curourt_name_lat')?></div><div class="column span-20 last">	<?=form_input('curourt_name_lat', set_value('curourt_name_lat', $ds->curourt_name_lat), 'id="curourt_name_lat" class="text part-5" ')?></div><div class="column span-4">
