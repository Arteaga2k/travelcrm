...
<h3><?=$title?></h3>
<?= form_open_multipart(get_currcontroller()."/edit/{$rid}", array('id'=>'edit_'.$orid, 'autocomplete'=>'off'))?>
...
<div class="column span-4">
	<?=form_label(lang('CARD_NUM'), '_dcarts_rid')?>
</div>
<div class="column span-20 last">
...
<fieldset>
	...
	<div class="column span-20 last">
		...
		<div class="column span-10 last">
			<?=form_dropdown('_clients_interests['.$interest->rid.']', get_interests_levels(), element($interest->rid, $this->input->post('_clients_interests'), element($interest->rid, get_client_interests($rid), null)), 'id="_clients_interests_'.$interest->rid.'"')?>
			<script type="text/javascript">
