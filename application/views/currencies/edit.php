...
<div class="column span-20 last">
	<?=form_input('code', set_value('code', $ds->code), 'id="code" class="text part-3"')?>
</div>
<div class="column span-4">
	<?=form_label(lang('NAME').required_field(), 'currency_name')?>
</div>
<div class="column span-20 last">
	<?=form_input('currency_name', set_value('currency_name', $ds->currency_name), 'id="currency_name" class="text part-3"')?>
</div>
...
<div class="column span-20 last">
	<?=form_input('left_word', set_value('left_word', $ds->left_word), 'id="left_word" class="text part"')?>
</div>
<div class="column span-4">
	<?=form_label(lang('RIGHT_WORD').required_field(), 'right_word')?>
</div>
<div class="column span-20 last">
	<?=form_input('right_word', set_value('right_word', $ds->right_word), 'id="right_word" class="text part"')?>
</div>
